...
const TabStack = ({ start, copilotEvents, route }) => {
  const { state, tutorial, notifications } = useApplicationStore(
    (state) => ({
      state: state.state,
    ...
    >
      <Tab.Screen
        ...
        options={({ navigation }) => ({
          ...
          tabBarIcon: ({ color, size }) => (
            <CopilotStep
              order={3}
              text={i18n.t("tabStack.scanMessage")}
              name={i18n.t("scanScreen.title")}
            >
              <CopilotWrapper>
                <TouchableOpacity
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <CopilotStep
              order={2}
              text={i18n.t("tabStack.entitiesMessage")}
              name={i18n.t("entitiesScreen.title")}
            >
              <CopilotWrapper>
                <TabWrap
                  style={{
                ...
                >
                  <EntitiesIcon name="entities" size={size} color={color} />
                </TabWrap>
              </CopilotWrapper>
            </CopilotStep>
          ),
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <CopilotStep
              text={i18n.t("tabStack.credentialsMessage")}
              order={1}
              name={i18n.t("credentialsScreen.title")}
              active={true}
            >
              <CopilotWrapper>
                <TabWrap
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <CopilotStep
              text={i18n.t("tabStack.notificationsMessage")}
              order={4}
              name={i18n.t("notificationsScreen.title")}
              active={true}
            >
              <CopilotWrapper>
                <TabWrap
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <CopilotStep
              text={i18n.t("tabStack.settingsMessage")}
              order={5}
              name={i18n.t("settingsScreen.title")}
              active={true}
            >
              <CopilotWrapper>
                <TabWrap
